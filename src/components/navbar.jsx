...
export default function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-10 sm:fixed md:fixed lg:fixed xl:fixed bg-gradient-to-r from-[#FAFAFA] to-[#FCFCFC] to-100% container mx-auto transition-all duration-300 ease-in-out">
            <div className={`navbar  bg-gradient-to-r from-[#FAFAFA] to-[#FCFCFC] to-100% fixed top-0 left-0 right-0 z-10 transition-all duration-300 ease-in-out xl:px-28 ${isSticky ? "shadow-md  transition-all duration-300 ease-in-out ease-in-out" : ""}`}>
