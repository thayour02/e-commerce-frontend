    ...
    <div className="min-h-screen pt-20">
        ...
        >
          ...
          <div className="text-center">
            ...
            >
              ...
              pariatur veritatis fuga et possimus dolore, ducimus magnam natus
              eum illo, ab odio recusandae.
            </motion.p>
      ...
      <div className="max-w-screen-2xl container mx-auto md:px-24 px-4">
        <div>
          ...
          <div className="flex md:justify-between items-center flex-col flex-wrap md:flex-row space-y-3 mb-6">
            <div className="gap-4 md:gap-8  flex md:items-center flex-row justify-start flex-wrap ">
              ...
              <button
                onClick={() => filterData("soups")}
                className={selectedCategory === "soups" ? "active" : ""}
              >
                Soups
              </button>
              <button
                onClick={() => filterData("drinks")}
                className={selectedCategory === "drinks" ? "active" : ""}
              >
                Drinks
              </button>
              <button
                onClick={() => filterData("desserts")}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 md:-mx-16  gap-20 mt-10">
